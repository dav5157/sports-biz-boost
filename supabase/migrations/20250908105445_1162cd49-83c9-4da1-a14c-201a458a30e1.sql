-- Check and update employee roles enum to match hierarchy
...
-- Update employees table with new role column (since old one was dropped with CASCADE)
...
-- Update existing employees with commission rates and roles
